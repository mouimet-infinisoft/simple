        ...
        <div className="calendar-sidebar">
          <PerfectScrollbar className="sidebar-body">
            <div className="d-grid mb-3">
              <Button variant="primary" onClick={handleModalShow}>Créer un nouvel événement</Button>
            </div>
                ...
                <li className="event-item" key={index}>
                  <div className="event-body">
                    ...
                    <div className="mutual-badge">
                      ...
                      <label>{event.mutual.user} et {event.mutual.count} autres participent</label>
                    </div>
                  </div>
                </li>
              ))}
            ...
            <Nav className="nav-calendar mb-4">
              <Nav.Link href="" className="calendar"><span></span> Événements du calendrier</Nav.Link>
              <Nav.Link href="" className="birthday"><span></span> Événements d'anniversaire</Nav.Link>
              <Nav.Link href="" className="holiday"><span></span> Calendrier des jours fériés</Nav.Link>
              <Nav.Link href="" className="discover"><span></span> Événements découverts</Nav.Link>
              <Nav.Link href="" className="meetup"><span></span> Événements Meetup</Nav.Link>
              <Nav.Link href="" className="other"><span></span> Autres événements</Nav.Link>
            </Nav>
